...
/// <summary>
/// \brief 외부 프로토콜 메시지와 Dreamine 표준 MessageEnvelope 간 변환을 담당하는 계약입니다.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// \brief 수신된 원시 메시지 데이터를 MessageEnvelope로 변환합니다.
    /// </summary>
    ...
    /// <summary>
    /// \brief MessageEnvelope를 외부 프로토콜 송신 데이터로 변환합니다.
    /// </summary>
